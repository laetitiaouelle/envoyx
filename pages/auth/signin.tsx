...
import { svg1 } from '../../src/constant/image'
        ...
        <div className='grid grid-cols-2 h-full items-center'>
            <div className='col-span-1 p-10' >
                <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.5}}>
                    <span className='block text-text-dark text-4xl text-center mb-2 font-bold'>{"Welcome back!"}</span>
                    <span className='block text-text-dark text-4xl text-center mb-6 font-bold'> {"Please sign in to your"} <span className='inline underline text-main-red' >  {"EnvoyX"} </span> {"account"}</span>
            ...
            <div className='col-span-1 bg-white-two  h-full px-10 flex items-center ' >
                <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.5}} className='w-full bg-[#fff] rounded-xl' >
                    <div className='w-full pt-10' >
                        <div className='text-text-dark font-bold text-center text-xl ' >Sign in</div>
                    ...
                    <form onSubmit={handleSubmit((data) => alert(data))} className='grid grid-cols-1 pt-10 px-10 space-y-5' >
                        ...
                        <div className='col-span-1 w-full' >
                            <input onClick={()=>router.push('/dashboard')} type="submit" className='text-[#fff] w-full h-10 rounded-[10px] bg-main-blue cursor-pointer ' />
                        </div>
                    </form>
