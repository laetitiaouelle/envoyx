...
function Contact() {
  ...
  return (
    <div className='py-[100px] w-full px-10 grid grid-cols-10 gap-20 '  >
      <div className='col-span-4 flex flex-col items-center justify-start gap-5' >
        ...
        <div className='text-text-dark text-opacity-60 font-lato text-xl' >
          ...
          <div className='ml-3 mt-3 text-lg text-center'>
